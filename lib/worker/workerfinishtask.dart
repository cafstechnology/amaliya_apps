...
class WorkerFinishTaskPage extends StatefulWidget {
  final String taskid;

  const WorkerFinishTaskPage({Key key, this.taskid}) : super(key: key);
  @override
  _WorkerFinishTaskPageState createState() =>
      _WorkerFinishTaskPageState(taskid);
}

class _WorkerFinishTaskPageState extends State<WorkerFinishTaskPage> {
  List<Step> steps;
  TextEditingController _remarksController;
  _WorkerFinishTaskPageState(String taskid);
  @override
  void initState() {
