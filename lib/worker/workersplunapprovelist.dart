...
class WorkerSplUnapproveList extends StatefulWidget {
  final String tw;
  WorkerSplUnapproveList({Key key, this.tw}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return new _WorkerSplUnapproveListState(this.tw);
  }
}
...
class _WorkerSplUnapproveListState extends State<WorkerSplUnapproveList> {
  _WorkerSplUnapproveListState(String tw);
  List<Spl> list = [];
  ...
  Future<List> getListTask() async {
    try {
      ...
      for (int i = 0; i < responseList.data.length; i++) {
        ...
        print(items.status + " vs " + AppConfig.pending);
