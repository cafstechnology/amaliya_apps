...
class WorkerSplRejectedList extends StatefulWidget {
  final String tw;
  WorkerSplRejectedList({Key key, this.tw}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return new _WorkerSplRejectedListState(this.tw);
  }
}
...
class _WorkerSplRejectedListState extends State<WorkerSplRejectedList> {
  _WorkerSplRejectedListState(String tw);
  List<Spl> list = [];
